		  	...
		  	<div class="panel panel-default">
			  <div class="panel-heading">
			    <h3 class="panel-title"><span class="fa fa-file"></span> Data Bengkel</h3>
			  </div>
			  <div class="panel-body">
			    <ul class="nav nav-pills nav-stacked">
			  ...
			  <div class="panel-body">
			    <ul class="nav nav-pills nav-stacked">
				  ...
				  <li role="presentation"><a href="cetaknota.php" target=""><span class="fa fa-file-pdf-o"></span> Laporan Transaksi</a></li>
				</ul>
			  </div>
			</div>
		  	<div class="panel panel-default">
			  ...
			  <div class="panel-body">
			    <ul class="nav nav-pills nav-stacked">
				  <li role="presentation"><a href="user.php"><span class="fa fa-user"></span> Pengguna</a></li>
