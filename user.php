...
<form method="post">
    <div class="row">
        ...
        <div class="col-md-6 text-right">
            ...
            <button type="button" onclick="location.href='user-baru.php'" class="btn btn-primary"><span class="fa fa-clone"></span> Kelola Data</button>
    ...
    ?>
            <tr>
                <td style="vertical-align:middle;"><?php echo $row['id_pengguna'] ?></td>
