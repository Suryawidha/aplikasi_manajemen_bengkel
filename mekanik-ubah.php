...
if($_POST){
	...
	if($eks->update()){
		echo "<script>location.href='mekanik-baru.php'</script>";
	} else{
?>
...
?>
		...
		<div class="panel-body">
			    ...
			    <form method="post">
				  ...
				  <button type="button" onclick="location.href='mekanik-baru.php'" class="btn btn-success"><span class="fa fa-history"></span> Batal</button>
				</form>
