...
if($_POST){
	...
	if($login->login()){
		...
		echo "<script class='alert-danger'>alert('Maaf password dan kata sandi tidak cocok')</script>";
	}
}
?>
<!DOCTYPE html>
	...
	<nav class=" navbar navbar-default navbar-static-top">
	  <div class="container">
		...
		<div class="navbar-header">
		  <a class="navbar-brand">MOTOR MABUR</a>
		</div>
		...
		<div class="row">
		  ...
		  <div class="col-xs-12 col-sm-4 col-md-4">
		  	...
		  	<div style="margin-top: 100px;" class="panel panel-default"><div class="panel-body">
		  		<div class="text-center"><h4><img src="images/racing.png" class="img-responsive"></h4></div>
		  		<form method="post">
